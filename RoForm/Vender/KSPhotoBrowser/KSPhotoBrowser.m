...
- (void)setupTitleLabel{
    NSString *titlePage = [NSString stringWithFormat:@"%zd/%zd",_currentPage + 1,_photoItems.count];
...
- (void)setupSaveButton{
    ...
    [saveButton setImage:[UIImage imageNamed:@"common_picture_save"] forState:UIControlStateNormal];
    [saveButton setImage:[UIImage imageNamed:@"common_picture_save"] forState:UIControlStateHighlighted];
...
- (void)saveButtonClick{
    ...
    UIImage *image = [KSSDImageManager imageFromMemoryForURL:item.imageUrl];
    if(image){
        UIImageWriteToSavedPhotosAlbum(image, nil, nil, nil);
        [QMUITips showSucceed:@"已保存到系统相册"];
    }else{
        [QMUITips showError:@"下载失败"];
    }
...
- (void)setupBackButton{
    ...
    [backButton setImage:[UIImage imageNamed:@"common_button_back_nor"] forState:UIControlStateNormal];
    [backButton setImage:[UIImage imageNamed:@"common_button_back_nor"] forState:UIControlStateHighlighted];
    ...
    [backButton setImage:[UIImage qmui_imageWithShape:QMUIImageShapeNavBack size:CGSizeMake(10, 18) lineWidth:2 tintColor:tintColor] forState:UIControlStateNormal];
    [backButton setImage:[UIImage qmui_imageWithShape:QMUIImageShapeNavBack size:CGSizeMake(10, 18) lineWidth:2 tintColor:tintColor] forState:UIControlStateHighlighted];
    ...
    [backButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.offset(StatusBarHeight);
        make.left.offset(0);
        make.size.mas_equalTo(CGSizeMake(44 - 6, 44));
    }];
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    self.titleLabel.text = [NSString stringWithFormat:@"%zd/%zd",_currentPage + 1,_photoItems.count];
}
