...
- (void)changeColor {
    ...
    if ([HXPhotoCommon photoCommon].isDark) {
        ...
        navBarBackgroudColor = [UIColor hx_colorWithHexStr:@"#131B18"];
        ...
        if (self.manager.configuration.doneBtnShowDetail) {
            if (!self.manager.configuration.selectTogether) {
                if (self.manager.selectedPhotoCount > 0) {
                    ...
                    [self.doneBtn setTitle:[NSString stringWithFormat:@"%@(%ld/%ld)",[NSBundle hx_localizedStringForKey:@"确定"],(long)selectCount,(long)maxCount] forState:UIControlStateNormal];
                }else {
                ...
                [self.doneBtn setTitle:[NSString stringWithFormat:@"%@(%ld/%lu)",[NSBundle hx_localizedStringForKey:@"确定"],(long)selectCount,(unsigned long)self.manager.configuration.maxNum] forState:UIControlStateNormal];
            }
        }else {
